...
class Dnp3Adapter extends utils.Adapter {
    ...
    async registerPoint(point) {
        ...
        const writable = this.settings.mode === 'outstation' || type === 'binaryOutputStatus' || type === 'analogOutputStatus';
    ...
    async onStateChange(id, state) {
        ...
        else if (type === 'binaryOutputStatus' || type === 'analogOutputStatus') this.protocol.directOperate(type, index, point.value);
...
if (require.main !== module) module.exports = options => new Dnp3Adapter(options);
else new Dnp3Adapter();
